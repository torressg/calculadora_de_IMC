...
class HistSQLitePage extends StatefulWidget {
  const HistSQLitePage({super.key});

  @override
  State<HistSQLitePage> createState() => _HistSQLitePageState();
}

class _HistSQLitePageState extends State<HistSQLitePage> with WidgetsBindingObserver {
  List<IMCSQLiteModel> _imc = <IMCSQLiteModel>[];
